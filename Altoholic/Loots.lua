...
Altoholic.Loots.List = {
	...
	-- ** for those who might still have these items, keep the table, but make its name different."Naxxramas" only will be for lv80
	[BZ["Naxxramas"] .. " " .. L["Level"] .. " 60"] = { 
	...
	[BZ["Hellfire Ramparts"] .. L[" (Heroic)"]] = {
		[BB["Watchkeeper Gargolmar"]] = { 29434, 30593, 30594, 30592, 27448, 27451, 27450, 27447, 27449, 23881	},
		[BB["Omor the Unscarred"]] = { 29434, 27466, 27462, 27467, 27478, 27539, 27906, 27464, 27895, 27477, 
											27463, 27476, 23886, 30593, 30594, 30592, 27465 },
		[L["Fel Iron Chest"]] = { 29434, 29264, 32077, 29238, 29346, 27452, 27461, 27456, 27454, 27458, 
	...
	[BZ["The Blood Furnace"] .. L[" (Heroic)"]] = {
		[BB["The Maker"]] = { 29434, 30601, 30600, 30602, 27485, 27488, 27483, 27487, 27484 },
		[BB["Broggok"]] = { 29434, 30601, 30600, 30602, 27848, 27492, 27489, 27491, 27490	},
		[BB["Keli'dan the Breaker"]] = { 29434, 32080, 29245, 29239, 29347, 27506, 27514, 27522, 27494, 27505, 
	...
	[BZ["The Shattered Halls"] .. L[" (Heroic)"]] = {	
		[BB["Grand Warlock Nethekurse"]] = { 29434, 24312, 30548, 30547, 30546, 27519, 27517, 27521,
									27520, 27518, 23735, 25462, 21525	},
		[BB["Blood Guard Porung"]] = { 29434, 30548, 30547, 30546, 30709, 30707, 30708, 30705, 30710 },
		[BB["Warbringer O'mrogg"]] = { 29434, 30548, 30547, 30546, 27525, 27868, 27524, 27526, 30829, 27802	},
		[BB["Warchief Kargath Bladefist"]] = { 29434, 29255, 29263, 29254, 29348, 27527, 27529, 27534, 27533, 27538, 
	...
	[BZ["The Slave Pens"] .. L[" (Heroic)"]] = {	
		[BB["Mennu the Betrayer"]] = { 29434, 30604, 30605, 30603, 27542, 27545, 27541, 27546, 27544, 27543, 29674 },
		[BB["Rokmar the Crackler"]] = { 29434, 30604, 30605, 30603, 27550, 27547, 28124, 27549, 27548, 27551 },
		[BB["Quagmirran"]] = { 29434, 29242, 30538, 32078, 29349, 27712, 27800, 28337, 27672, 27742, 
							33821, 30604, 30605, 30603, 27796, 27713, 27740, 27683, 27714, 27673, 27741 }
	},
	[BZ["The Underbog"]] = {
	...
	[BZ["The Underbog"] .. L[" (Heroic)"]] = {
		[BB["Hungarfen"]] = { 29434, 30606, 30607, 30608, 27746, 27745, 27743, 27748, 27744, 27747	},
		[BB["Ghaz'an"]] = { 29434, 30606, 30607, 30608, 27760, 27759, 27755, 27758, 27761, 27757 },
		[BB["Swamplord Musel'ek"]] = {	29434, 30606, 30607, 30608, 27764, 27763, 27765, 27766, 27762, 27767 },
		[BB["The Black Stalker"]] = { 29434, 29265, 30541, 32081, 29350, 27781, 27768, 27938, 27773, 27779, 
	...
	[BZ["The Steamvault"] .. L[" (Heroic)"]] = {
		[BB["Hydromancer Thespia"]] = { 29434, 30550, 30551, 30549, 27789, 27787, 27783, 27784, 29673, 30828, 27508 },
		[BB["Mekgineer Steamrigger"]] = {	29434, 30550, 30551, 30549, 27793, 27790, 27792, 27791, 27794, 23887 },
		[BB["Warlord Kalithresh"]] = {	29434, 30543, 29243, 29463, 29351, 27804, 27799, 27795, 27806, 27805, 
	...
	[BZ["Mana-Tombs"] .. L[" (Heroic)"]] = {	
		[BB["Pandemonius"]] = { 29434, 30584, 30585, 30583, 27816, 27818, 27813, 27815, 27814, 27817 },
		[BB["Tavarok"]] = { 29434, 30584, 30585, 30583, 27824, 27821, 27825, 27826, 27823, 27822 },
		[BB["Nexus-Prince Shaffar"]] = { 29434, 29240, 30535, 29352, 32082, 27831, 27843, 27827, 27835, 27844, 
	...
	[BZ["Auchenai Crypts"] .. L[" (Heroic)"]] = {
		[BB["Shirrak the Dead Watcher"]] = {	29434, 30587, 30588, 30586, 27866, 27493, 27865, 27845, 27847, 27846 },
		[BB["Exarch Maladaar"]] = { 29434, 29354, 29257, 29244, 27867, 27871, 27869, 27523, 27872, 21525, 
	...
	[BZ["Sethekk Halls"] .. L[" (Heroic)"]] = {	
		[BB["Darkweaver Syth"]] = {	29434, 30553, 30554, 30552, 27919, 27914, 27915, 27918, 27917, 27916, 
										24160, 27633, 25461 },
		[BB["Talon King Ikiss"]] = { 29434, 29249, 29259, 32073, 29355, 27946, 27981, 27985, 27925, 27980, 
	...
	[BZ["Shadow Labyrinth"] .. L[" (Heroic)"]] = {	
		[BB["Ambassador Hellmaw"]] = { 29434, 30563, 30559, 30560, 27889, 27888, 27884, 27886, 27887, 27885 },
		[BB["Blackheart the Inciter"]] = { 29434, 30563, 30559, 30560, 27892, 27893, 28134, 27891, 27890, 25728, 
									30808, 27468 },
		[BB["Grandmaster Vorpil"]] = { 29434, 30563, 30559, 30560, 27897, 27900, 27901, 27898, 21525, 30827, 27775 },
		[BB["Murmur"]] = { 29434, 29241, 30532, 29357, 29261, 29353, 27902, 27912, 27913, 27905, 
	...
	[BZ["Old Hillsbrad Foothills"] .. L[" (Heroic)"]] = {	
		[BB["Lieutenant Drake"]] = { 29434, 30589, 30591, 30590, 28212, 28214, 28215, 28211, 28213, 28210 },
		[BB["Captain Skarloc"]] = {	29434, 30589, 30591, 30590, 28218, 28220, 28219, 28221, 28217, 28216, 
									21524, 22927 },
		[BB["Epoch Hunter"]] = { 29434, 29250, 29246, 29357, 30534, 30536, 27911, 28344, 28233, 27904, 
	...
	[BZ["The Black Morass"] .. L[" (Heroic)"]] = {	
		[BB["Chrono Lord Deja"]] = { 29434, 30558, 30556, 30555, 27988, 27994, 27995, 27993, 27996, 27987, 29675 },
		[BB["Temporus"]] = { 29434, 30558, 30556, 30555, 28185, 28186, 28034, 28187, 28184, 28033 },
		[BB["Aeonus"]] = { 29434, 30531, 29247, 29253, 29356, 28206, 28194, 28207, 28190, 28189, 
	...
	[BZ["The Mechanar"] .. L[" (Heroic)"]] = {	
		[BB["Mechano-Lord Capacitus"]] = { 29434, 30565, 30566, 30564, 28256, 28255, 28254, 28257, 28253, 35582 },
		[BB["Nethermancer Sepethrea"]] = { 29434, 30565, 30566, 30564, 28262, 28259, 28260, 28263, 28258, 21524, 22920},
		[BB["Pathaleon the Calculator"]] = { 29434, 29251, 32076, 30533, 29362, 28269, 28266, 28265, 28288, 27899, 
				28267, 28286, 21907, 30565, 30566, 30564, 28278, 28202, 28204, 28275, 28285, 33860, 31086 }
	},
	[BZ["The Botanica"]] = {	
	...
	[BZ["The Botanica"] .. L[" (Heroic)"]] = {	
		[BB["Commander Sarannis"]] = {	29434, 30574, 30572, 30573, 28301, 28304, 28306, 28296, 28311 },
		[BB["High Botanist Freywinn"]] = { 29434, 30574, 30572, 30573, 28317, 28318, 28321, 28315, 28316, 
												21524, 23617, 31744 },
		[BB["Thorngrin the Tender"]] = { 29434, 30574, 30572, 30573, 24310, 28324, 28327, 28323, 28322, 28325 },
		[BB["Laj"]] = { 29434, 30574, 30572, 30573, 28328, 28338, 28340, 28339, 27739 },
		[BB["Warp Splinter"]] = { 29434, 29258, 29262, 32072, 29359, 24311, 28371, 28342, 28347, 28343, 
	...
	[BZ["The Arcatraz"] .. L[" (Heroic)"]] = {	
		[BB["Zereketh the Unbound"]] = { 29434, 30582, 30575, 30581, 28373, 28374, 28384, 28375, 28372 },
		[BB["Wrath-Scryer Soccothrates"]] = { 29434, 30582, 30575, 30581, 28396, 28398, 28394, 28393, 28397	},
		[BB["Dalliah the Doomsayer"]] = {	29434, 30582, 30575, 30581, 24308, 28391, 28390, 28387, 28392, 28386 },
		[BB["Harbinger Skyriss"]] = { 29434, 29241, 29248, 29252, 29360, 28406, 28419, 28407, 28418, 28412, 
	...
	[BZ["Magisters' Terrace"] .. L[" (Heroic)"]] = {
		[BB["Selin Fireheart"]] = { 29434, 34602, 34601, 34604, 34603, 34702, 34697, 34698, 34701, 34700, 
									34699, 35275 },
		[BB["Vexallus"]] = { 29434, 34607, 34605, 34606, 34608, 34708, 34705, 34707, 34704, 34706, 34703 },
		[BB["Priestess Delrissa"]] = { 29434, 34473, 34471, 34470, 34472, 34792, 34788, 34791, 34789, 34790, 
									34783, 35756, 35275 },
		[BB["Kael'thas Sunstrider"]] = { 29434, 34610, 34613, 34614, 34615, 34612, 34611, 34609, 34616, 34810, 
	...
	-- ** WotLK 5-men **
	[BZ["Utgarde Keep"]] = {
		[BB["Prince Keleseth"]] = { 35570, 35571, 35572 },
		[BB["Skarvald the Constructor"]] = { 35573, 35574, 35575 },
		[BB["Ingvar the Plunderer"]] = { 35576, 35577, 35578, 33330, 38218, 38219, 38220 },
		[L["Trash Mobs"]] = { 35579, 35580 },
	},
	[BZ["Utgarde Keep"] .. L[" (Heroic)"]] = {
		[BB["Prince Keleseth"]] = { 37177, 37178, 37179, 37180 },
		[BB["Skarvald the Constructor"]] = { 37181, 37182, 37183, 37184 },
		[BB["Ingvar the Plunderer"]] = { 37186, 37188, 37189,	37190, 37191, 37192,	37193, 37194, 43662 },
		[L["Trash Mobs"]] = { 37196, 37197, 40752 }
	},
	[BZ["The Nexus"]] = {
		[BB["Grand Magus Telestra"]] = { 35605, 35604, 35617 },
		[BB["Ormorok the Tree-Shaper"]] = { 35602, 35603, 35601 },
		[BB["Anomalus"]] = { 35599, 35600, 35598 },
		[BB["Keristrasza"]] = { 35596, 35597, 35595 },
		["Commander Stoutbeard"] = { 37728, 37731, 37730,	37729 },
	},
	[BZ["The Nexus"] .. L[" (Heroic)"]] = {
		[BB["Grand Magus Telestra"]] = { 37139, 37138, 37135, 37134 },
		[BB["Ormorok the Tree-Shaper"]] = { 37153, 37155, 37152,	37151 },	
		[BB["Anomalus"]] = { 37149, 37144, 37150,	37141 },	
		[BB["Keristrasza"]] = { 37172, 37170, 37171, 37169, 37165, 37167,	37166, 37162, 43665 }
	},
	[BZ["Azjol-Nerub"]] = {
		[BB["Krik'thir the Gatewatcher"]] = { 35657, 35656, 35655 },
		[BB["Hadronox"]] = { 35660, 35659, 35658 },
		[BB["Anub'arak"]] = { 35663, 35662, 35661, 43411 }
	},
	[BZ["Azjol-Nerub"] .. L[" (Heroic)"]] = {
		[BB["Krik'thir the Gatewatcher"]] = { 37218, 37219, 37217, 37216 },
		[BB["Hadronox"]] = { 37222, 37230, 37221,	37220 },
		[BB["Anub'arak"]] = { 37242, 37240, 37241, 37238, 37236, 37237, 37232, 37235, 43726 },
		[L["Trash Mobs"]] = { 37243, 40752, 37625, 37624 },
	},
	[BZ["Ahn'kahet: The Old Kingdom"]] = {
		[BB["Prince Taldaram"]] = { 35611, 35610, 35609 },
		[BB["Elder Nadox"]] = { 35607, 35608, 35606 },
		[BB["Jedoga Shadowseeker"]] = { 43278, 43279, 43277 },
		[BB["Herald Volazj"]] = { 35612, 35613, 35614 },
		[L["Trash Mobs"]] = { 35616, 35615 }
	},
	[BZ["Ahn'kahet: The Old Kingdom"] .. L[" (Heroic)"]] = {
		[BB["Prince Taldaram"]] = { 37613, 37614, 37612, 37595 },
		[BB["Elder Nadox"]] = { 37594, 37593, 37592, 37591 },
		[BB["Jedoga Shadowseeker"]] = { 43283, 43280, 43282, 43281 },
		[BB["Herald Volazj"]] = { 37622, 37623, 37620, 37619, 37616, 37618, 37617, 37615 },
		["Amanitar"] = { 43287, 43286, 43285, 43284 },
		[L["Trash Mobs"]] = { 37625, 37624 }
	},
	[BZ["Drak'Tharon Keep"]] = {
		[BB["Trollgore"]] = { 35620, 35619, 35618,  },
		[BB["Novos the Summoner"]] = { 35632, 35631, 35630 },
		[BB["King Dred"]] = { 35635, 35634, 35633 },
		[BB["The Prophet Tharon'ja"]] = { 35638, 35637, 35636 },
		[L["Trash Mobs"]] = { 35641, 35640, 35639 },
	},
	[BZ["Drak'Tharon Keep"] .. L[" (Heroic)"]] = {
		[BB["Trollgore"]] = { 37715, 37714, 37717, 37712 },	
		[BB["Novos the Summoner"]] = { 37722, 37718, 37721 },	
		[BB["King Dred"]] = { 37725, 37724, 37726, 37723 },	
		[BB["The Prophet Tharon'ja"]] = { 37798, 37791, 37788, 37784, 37735, 37732, 37734, 37733 },
		[L["Trash Mobs"]] = { 37799, 37800, 37801 },
	},
	[BZ["The Violet Hold"]] = {
		[BB["Erekem"]] = { 43363, 43375 },
		[BB["Ichoron"]] = { 35647, 35643 },	
		[BB["Lavanthor"]] = { 35646, 35645 },	
		[BB["Moragg"]] = { 43387, 43382 },	
		[BB["Xevozz"]] = { 35644, 35642 },	
		[BB["Zuramat the Obliterator"]] = { 43353, 43358 },	
		[BB["Cyanigosa"]] = { 35650, 35651, 35649 },
		[L["Trash Mobs"]] = { 35653, 35652, 35654 },
	},
	[BZ["The Violet Hold"]  .. L[" (Heroic)"]] = {
		[BB["Erekem"]] = { 43406, 43405, 43407 },
		[BB["Ichoron"]] = { 43401, 37862, 37869 },	
		[BB["Lavanthor"]] = { 37870, 37872, 37871 },	
		[BB["Moragg"]] = { 43410, 43408, 43409 },	
		[BB["Xevozz"]] = { 37867, 37868, 37861 },	
		[BB["Zuramat the Obliterator"]] = { 43403, 43402, 43404 },	
		[BB["Cyanigosa"]] = { 37884, 37886, 43500, 37883, 37876, 37875, 37874, 37873, 41791, 40752 },
		[L["Trash Mobs"]] = { 37889, 37890, 37891 },
	},
	[BZ["Gundrak"]] = {
		[BB["Slad'ran"]] = { 35584, 35585, 35583 },
		[BB["Moorabi"]] = { 35588, 35589, 35587 },
		[BB["Drakkari Colossus"]] = { 35591, 35592, 35590 },
		[BB["Gal'darah"]] = { 43305, 43309, 43306 },
		[L["Trash Mobs"]] = { 35594, 35593 },
	},
	[BZ["Gundrak"] .. L[" (Heroic)"]] = {
		[BB["Slad'ran"]] = { 37629, 37628, 37627, 37626 },	
		[BB["Moorabi"]] = { 37630, 37633, 37632, 37631 },
		[BB["Drakkari Colossus"]] = { 37637, 37636, 37634, 37635 },	
		[BB["Gal'darah"]] = { 37643, 37644, 37645, 37642, 37641, 37640, 37639, 37638, 43693 },	
		[BB["Eck the Ferocious"]] = { 43313, 43312, 43311, 43310 },
		[L["Trash Mobs"]] = { 37646, 37647, 37648 },
	},
	[BZ["Halls of Stone"]] = {
		[BB["Maiden of Grief"]] = { 38614, 38613, 38611 },
		[BB["Krystallus"]] = { 35673, 35672, 35670 },
		[BB["Sjonnir The Ironshaper"]] = { 35679, 35678, 35680 },
		[BB["The Tribunal of Ages"]] = { 35677, 35676, 35675 },
		[L["Trash Mobs"]] = { 35682, 35683, 35681 }
	},
	[BZ["Halls of Stone"] .. L[" (Heroic)"]] = {
		[BB["Maiden of Grief"]] = { 38616, 38615, 38617, 38618 },	
		[BB["Krystallus"]] = { 37652, 37650, 37651, 37653 },	
		[BB["Sjonnir The Ironshaper"]] = { 37669, 37668, 37670, 37667, 37666, 37658, 37657, 37660, 43699 },	
		[BB["The Tribunal of Ages"]] = { 37655, 37656, 37654 },
		[L["Trash Mobs"]] = { 37671, 37673, 37672 }
	},
	[BZ["Halls of Lightning"]] = {
		[BB["General Bjarngrim"]] = { 36982, 36979, 36981, 36980 },
		[BB["Ionar"]] = { 39536, 39657, 39534, 39535 },
		[BB["Volkhan"]] = { 36983, 36985, 36986, 36984, },
		[BB["Loken"]] = { 36991, 36996, 36992, 36995, 36988, 36993, 36989, 36994 },
		[L["Trash Mobs"]] = { 36997, 37000, 36999 }
	},
	[BZ["Halls of Lightning"] .. L[" (Heroic)"]] = {
		[BB["General Bjarngrim"]] = { 37825, 37818, 37814, 37826 },	
		[BB["Ionar"]] = { 37846, 37845, 37826, 37844 },	
		[BB["Volkhan"]] = { 37840, 37843, 37842, 37841 },	
		[BB["Loken"]] = { 37854, 37853, 37855, 37852, 37851, 37850, 37849, 37848, 43724 },
		[L["Trash Mobs"]] = { 37858, 37857, 37856 }
	},
	[BZ["The Culling of Stratholme"]] = {
		[BB["Meathook"]] = { 37083, 37082, 37079, 37081 },
		[BB["Chrono-Lord Epoch"]] = { 37106, 37105, 37096, 37099 },
		[BB["Mal'Ganis"]] = { 37113, 37114, 37110, 37109, 37111, 37108, 37112, 37107 },
		[BB["Salramm the Fleshcrafter"]] = { 37084, 37095, 37088, 37086 },
	},
	[BZ["The Culling of Stratholme"] .. L[" (Heroic)"]] = {
		[BB["Meathook"]] = { 37680, 37678, 37679, 37675 },	
		[BB["Chrono-Lord Epoch"]] = { 37687, 37686, 37688, 37685 },	
		[BB["Mal'Ganis"]] = { 37696, 37695,	37694, 37693, 43085,	37691, 37690, 37689, 37692, 43697 },	
		[BB["Salramm the Fleshcrafter"]] = { 37684, 37682, 37683, 37681 },	
		[BB["Infinite Corruptor"]] = { 43951 },	
		[L["Trash Mobs"]] = { 37117, 37116, 37115 }
	},
	[BZ["Utgarde Pinnacle"]] = {
		[BB["Skadi the Ruthless"]] = { 37055, 37057, 37056, 37053 },
		[BB["King Ymiron"]] = { 37067, 37062, 37066,	37058, 37064, 37065, 37060, 37061 },
		[BB["Svala Sorrowgrave"]] = { 37043, 37040, 37037, 37038 },
		[BB["Gortok Palehoof"]] = { 37048, 37052, 37051, 37050 },
		[L["Trash Mobs"]] = { 37070, 37069, 37068 },
	},	
	[BZ["Utgarde Pinnacle"] .. L[" (Heroic)"]] = {
		[BB["Skadi the Ruthless"]] = { 37389, 37379, 37377, 37384, 44151 },	
		[BB["King Ymiron"]] = { 37408, 37409, 37407,	37401, 37398, 37395, 37397, 37390, 43669 },
		[BB["Svala Sorrowgrave"]] = { 37370, 37369, 37368, 37367 },
		[BB["Gortok Palehoof"]] = { 37374, 37373, 37376, 37371 },
		[L["Trash Mobs"]] = { 37587, 37590, 37410 },
	},	
	[BZ["The Oculus"]] = {
		[BB["Drakos the Interrogator"]] = { 36945, 36946, 36943, 36944 },
		[BB["Ley-Guardian Eregos"]] = { 36973, 36971, 36969, 36974, 36961, 36972, 36962, 36975 },
		[BB["Mage-Lord Urom"]] = { 36954, 36951, 36953, 36952 },
		[BB["Varos Cloudstrider"]] = { 36947, 36949, 36948, 36950 },
		[L["Trash Mobs"]] = { 36978, 36977, 36976 },
	},	
	[BZ["The Oculus"] .. L[" (Heroic)"]] = {
		[BB["Drakos the Interrogator"]] = { 37258, 37256, 37257, 37255 },	
		[BB["Ley-Guardian Eregos"]] = { 37361, 37363, 37362,	37360, 37291, 37294, 37293, 37292, 43668 },	
		[BB["Mage-Lord Urom"]] = { 37289, 36951, 37288,	37264 },	
		[BB["Varos Cloudstrider"]] = { 37261, 37262, 37263, 37260 },	
		[L["Trash Mobs"]] = { 37366, 37365, 37290, 37364 },
	},	

	-- ** WotLK raids **
	[BZ["Naxxramas"] .. " (10)"] = {
		[BB["Patchwerk"]] = { 39272, 39273, 39275,	39274, 39267, 39262, 39261, 39270, 39271 },
		[BB["Grobbulus"]] = { 39284, 39285, 39283, 39278, 39279, 39280, 39282, 39277, 39281, 39276 },
		[BB["Gluth"]] = { 39308, 40622, 40623,	40624 },
		[BB["Thaddius"]] = {	39295, 39294, 39293, 39292, 39291, 40619, 40620, 40621 },
		[BB["Anub'Rekhan"]] = { 39190, 39191, 39192, 39189, 39188, 39139, 39146, 39193, 39141, 39140 },
		[BB["Grand Widow Faerlina"]] = { 39216, 39215, 39196, 39217, 39194, 39198, 39195, 39197, 39200, 39199 },
		[BB["Maexxna"]] = { 39225, 39230, 39224, 39228, 39232, 39231, 39229, 39226,  39221, 39233 },
		[BB["Instructor Razuvious"]] = { 39297, 39310, 39309, 39299, 39308, 39307, 39306, 39298, 39311, 39296 },
		[BB["Gothik the Harvester"]] = { 39390, 39386, 39391, 39379, 39345, 39369, 39392, 39389, 39388, 39344 },
		[BB["The Four Horsemen"]] = { 39393, 39396, 39397, 39394, 40610, 40611, 40612 },
		[BB["Noth the Plaguebringer"]] = { 39241, 39242, 39240, 39237, 39243, 39236, 39239, 39235, 39234, 39244 },
		[BB["Heigan the Unclean"]] = { 39252, 39254, 39247, 39248, 39251, 39249, 39246, 39250, 39245, 39255 },
		[BB["Loatheb"]] = { 39259, 39260, 39258, 39257, 39256, 40622, 40623, 40624 },
		[BB["Sapphiron"]] = { 39415, 39404, 39405, 39409, 39408, 39399, 39403, 39398, 39401, 39407, 44569, 44582 },
		[BB["Kel'Thuzad"]] = { 39425, 39421, 39420, 39424, 39423, 39416, 39417, 39422, 39426, 39419, 
										40616, 40617, 40618 },
		[L["Trash Mobs"]] = { 39467, 39470, 39472, 39427, 39468, 39473 },
	},
	[BZ["Naxxramas"] .. " (25)"] = {
		[BB["Patchwerk"]] = { 40271, 40269, 40260, 40270, 40262, 40272, 40261, 40263, 40259, 40071,
			40065, 40069, 40064, 40080, 40075, 40107, 40074, 40267, 40268, 40266,
			40264, 40265, 40273 },
		[BB["Grobbulus"]] = { 40250, 40254, 40252, 40253, 40251, 40287, 40286, 40351, 40289, 40277,	
			40285, 40288, 40283, 40282, 40275, 40279,	40274, 40278, 40257, 40255,	
			40258, 40256, 40281, 40280, 40284 },
		[BB["Gluth"]] = { 40261 },
		[BB["Thaddius"]] = {	40303, 40301, 40296, 40304, 40299, 40302, 40298, 40294, 40297, 40300,	
			40634, 40635, 40636 },
		[BB["Anub'Rekhan"]] = { 39719, 39721, 39720, 39722, 39701, 39702, 39718, 39704, 39703, 39717,	
			39706, 40071, 40065,	40069, 40064, 40080,	40075, 40107, 40074,	39716,	
			40208, 39712 },
		[BB["Grand Widow Faerlina"]] = { 39732, 39731, 39733, 39735, 39756, 39727, 39724, 39734, 39723, 39725,
			39729, 39726, 40071, 40065, 40069, 40064, 40080, 40075, 40107, 40108,
			40074, 39757, 39728, 39730 },
		[BB["Maexxna"]] = { 40250, 40254, 40252, 40253, 40251, 40062, 40060, 39768, 40063, 39765,
			39761, 40061, 39762,	39760, 39767, 39764,	39759, 40257, 40255,	40258,
			40256, 39766, 39763, 39758 },
		[BB["Instructor Razuvious"]] = { 40325, 40326, 40305, 40319, 40323, 40315, 40324, 40327, 40306, 40316,
			40317, 40318, 40320,	40071, 40065, 40069, 40064, 40080, 40075,	40107,	
			40074, 40321, 40322 },
		[BB["Gothik the Harvester"]] = { 40250, 40254, 40252, 40253, 40251, 40339, 40338, 40329, 40341, 40333,	
			40340, 40331, 40328,	40334, 40332, 40330,	40257, 40255, 40258,	40256,	
			40342, 40337, 40336,	40335 },
		[BB["The Four Horsemen"]] = { 40349, 40344, 40352, 40347, 40350, 40345, 40348, 40343, 40346, 40625,
			40626, 40627 },
		[BB["Noth the Plaguebringer"]] = { 40194, 40602, 40198, 40197, 40186, 40200, 40193, 40196, 40184, 40185,	
			40188, 40187, 40071,	40065, 40069, 40064, 40080, 40075, 40107,	40074,
			40192, 40191, 40189, 40190 },
		[BB["Heigan the Unclean"]] = { 40250, 40254, 40252, 40253, 40251, 40234, 40236, 40238, 40205, 40235,
			40209, 40201, 40237,	40203, 40210, 40204,	40206, 40257, 40255,	40258,
			40256, 40207, 40208,	40233 },
		[BB["Loatheb"]] = { 40247, 40246, 40249, 40243, 40242, 40241, 40240, 40244, 40239, 40245,	
			40637, 40638, 40639 },
		[BB["Sapphiron"]] = { 40381, 40380, 40376, 40362, 40379, 40367, 40366, 40377, 40365, 40363,
			40378, 40374, 40369,	40370, 40375, 40371,	40373, 40372, 40382,	40368,
			44577, 44581 },
		[BB["Kel'Thuzad"]] = { 40405, 40403, 40398, 40387, 40399, 40401, 40400, 40395, 40396, 40383,
			40402, 40386, 40384,	40388, 40385, 40631,	40632, 40633 },
		[L["Trash Mobs"]] = { 40410, 40409, 40414, 40412, 40408, 40407, 40406 }
	},
	[BZ["The Obsidian Sanctum"] .. " (10)"] = {
		[BB["Sartharion"]] = { 40428, 40427, 40426, 40433, 40430, 40429, 43345, 43347, 40613, 40614,
			40615, 43988, 43990, 43991, 43989, 43992, 43995, 43996, 43994, 43993, 43986 },
	},
	[BZ["The Obsidian Sanctum"] .. " (25)"] = {
		[BB["Sartharion"]] = { 40437, 40439, 40451, 40438, 40453, 40446, 40433, 40431, 40432, 40455,
			43345, 43346, 40628, 40629, 40630, 44002, 44003, 43998, 44004, 44000,
			44005, 44008, 44007, 44011, 44006, 43954 },
	},
	[BZ["The Eye of Eternity"] .. " (10)"] = {
		[BB["Malygos"]] = { 40526, 40519, 40511, 40486, 40474, 40491, 40488, 40489, 40497, 40475, 43953, 44569, 44650,
			44658, 44660, 44659, 44657 },
	},
	[BZ["The Eye of Eternity"] .. " (25)"] = {
		[BB["Malygos"]] = { 40562, 40555, 40194, 40561, 40560, 40558, 40594, 40539, 40541, 40566,
			40543, 40588, 40564, 40549, 40590, 40589, 40592, 40591, 40532, 40531,
			43952, 44577, 44650, 44664, 44662, 44665, 44661 },
	},
	[BZ["Ulduar"] .. " (10)"] = {
		[BB["Flame Leviathan"]] = { 45289, 45291, 45288, 45283, 45285, 45292, 45286, 45287, 45284, 45282 },
		...
		[BB["XT-002 Deconstructor"]] = { 45694, 45677, 45686, 45687, 45679, 45676, 45680, 45685, 45675, 45682 },
		[BB["The Iron Council"]] = { 45322, 45423, 45324, 45378, 45333, 45321, 45329, 45418, 45331, 45332,
			45458, 45506 },
		[BB["Kologarn"]] = { 45704, 45701, 45697, 45698, 45696, 45699, 45702, 45703, 45700, 45695 },
		[BB["Auriaya"]] = { 45865, 45864, 45709, 45711, 45712, 45708, 45866, 45707, 45713, 45832 },
		[BB["Hodir"]] = { 45873, 45464, 45874, 45458, 45872, 45650, 45651, 45652 },
		[BB["Thorim"]] = { 45893, 45927, 45894, 45895, 45933, 45931, 45929, 45930, 45892, 45784,
			45659, 45660, 45661 },
		[BB["Freya"]] = { 45940, 45941, 45935, 45936, 45934, 45947, 46110, 45645, 45646, 45644 },
		[BB["Mimiron"]] = { 45973, 45976, 45974, 45975, 45972, 45647, 45649, 45648 },
		[BB["General Vezax"]] = {  },
		[L["Trash Mobs"]] = { 46341, 46347, 46344, 46346, 46345, 46340, 46343, 46339, 46351, 44310,
			46350, 46342 },
	},
	[BZ["Ulduar"] .. " (" .. L["Hard Mode"] .. " 10)"] = {
		[BB["Flame Leviathan"]] = { 45293, 45300, 45295, 45297, 45296 },
		[BB["The Iron Council"]] = { 45330, 45456, 45447, 45448, 45449 },
		[BB["Hodir"]] = { 45888, 45876, 45886, 45887, 45877 },
	},
	[BZ["Ulduar"] .. " (25)"] = {
		[BB["Flame Leviathan"]] = { 45117, 45119, 45108, 45118, 45109, 45107, 45111, 45116, 45113, 45106,
			45112, 45115, 45114, 45110, 45086, 46348, 46027 },
		[BB["Ignis the Furnace Master"]] = { 45186, 45162, 45185, 45164, 45187, 45167, 45161, 45166,
			45168, 45157, 45158, 45169, 45165, 45171, 45170, 46348, 46027, 45097, 45102 },
		[BB["Razorscale"]] = { 45138, 45150, 45146, 45149, 45141, 45151, 45143, 45140,
			45139, 45162, 45166, 45148, 45510, 45144, 45142, 45147, 45137 },
		[BB["XT-002 Deconstructor"]] = { 45253, 45258, 45260, 45259, 45249, 45251, 45252, 45248, 45250, 45247,
			45255, 45254, 45246, 45256, 45257, 46348, 46027, 45094 },
		[BB["The Iron Council"]] = { 45224, 45240, 45238, 45237, 45232, 45227, 45239, 45226, 45225,
			45228, 45506, 45193, 45236, 45235, 45233, 45234, 46348 },
		[BB["Kologarn"]] = { 45272, 45275, 45273, 45265, 45274, 45264, 45269, 45268, 45267, 45262,
			45263, 45271, 45270, 45266, 45261, 45098, 46027, 45088, 45090, 45100, 45099, 45104, 45102 },
		[BB["Auriaya"]] = { 45319, 45435, 45441, 45439, 45325, 45440, 45320, 45334, 45480, 45326, 
			45438, 45436, 45315, 45437, 45327, 46348 },
		[BB["Hodir"]] = { 45453, 45454, 45452, 45451, 45450, 45632, 45634, 45633, 46027, 46348,
			45093, 45090, 45103 },
		[BB["Thorim"]] = { 45038, 46017, 45468, 45467, 45469,45466, 45463, 46027, 45095, 45640,
			45639, 45638, },
		[BB["Freya"]] = { 45483, 45482, 45481, 45480, 45479, 46110,46027, 45093, 45094, 45102,
			45653, 45655, 45654 },
		[BB["Mimiron"]] = { 45493, 45492, 45491, 45490, 45489, 46027, 46348, 45100, 45095, 45097,
			45093, 45641, 45642, 45643 },
		[BB["General Vezax"]] = { 45508, 45512, 45504, 45513, 45502, 45505, 45501, 45503, 45515, 45507,
			45509, 45145, 45498, 45511, 46027, 46348, 45092, 45093, 45096, 45103 },
		[L["Trash Mobs"]] = { 45541, 45547, 45548, 45543, 45544, 45542, 45540, 45539, 46138, 45605 },
		[L["Legendaries"]] = { 45038, 46017 },
	},
	[BZ["Ulduar"] .. " (" .. L["Hard Mode"] .. " 25)"] = {
		[BB["Flame Leviathan"]] = { 45135, 45136, 45134, 45133, 45132 },
		[BB["XT-002 Deconstructor"]] = { 45445, 45443, 45442 },
		[BB["The Iron Council"]] = { 45242, 45241 },
		[BB["Hodir"]] = { 45461, 45462, 45460, 45459, 45457 },
		[BB["General Vezax"]] = { 45518, 45516 },
	},
	...
	[BF["Alliance Vanguard"]] = {	
		[FACTION_STANDING_LABEL7] = { 38459, 38465, 38455, 38463, 38453, 38457, 38464 },
		[FACTION_STANDING_LABEL8] = { 44503, 44701 }
	},
	[BF["Argent Crusade"]] = {	
		[FACTION_STANDING_LABEL5] = { 43154 },
		[FACTION_STANDING_LABEL6] = { 44248, 44247, 44244, 44245, 44214, 41726, 44150 },
		[FACTION_STANDING_LABEL7] = { 44216, 44240, 44239, 44139 },
		[FACTION_STANDING_LABEL8] = { 44297, 44295, 44296, 44283, 42187 }
	},
	[BF["Frenzyheart Tribe"]] = {	
		[FACTION_STANDING_LABEL5] = { 41561, 44064, 44072 },
		[FACTION_STANDING_LABEL7] = { 44116, 44117, 44122, 44120, 44121, 44123,	44118, 41723, 44717 },
		[FACTION_STANDING_LABEL8] = { 44073 }
	},
	[BF["Horde Expedition"]] = {	
		[FACTION_STANDING_LABEL7] = { 38458, 38461, 38454, 38452, 38462, 38456, 38460 },
		[FACTION_STANDING_LABEL8] = { 44502, 44702 }
	},
	[BF["Kirin Tor"]] = {	
		[FACTION_STANDING_LABEL5] = { 43157 },
		[FACTION_STANDING_LABEL6] = { 44167, 44170, 44171, 44166, 44141 },
		[FACTION_STANDING_LABEL7] = { 44179, 44176, 44173, 44174, 44159 },
		[FACTION_STANDING_LABEL8] = { 44180, 44181, 44182, 44183, 41718, 42188 }
	},
	[BF["Knights of the Ebon Blade"]] = {	
		[FACTION_STANDING_LABEL5] = { 41562, 43155 },
		[FACTION_STANDING_LABEL6] = { 44242, 44243, 44241, 44512, 44138 },
		[FACTION_STANDING_LABEL7] = { 44256, 44258, 44257, 44250, 44249, 41721, 44149, 42183 },
		[FACTION_STANDING_LABEL8] = { 44302, 44303, 44305, 44306 }
	},
	[BF["The Kalu'ak"]] = {	
		[FACTION_STANDING_LABEL5] = { 41568, 44049 },
		[FACTION_STANDING_LABEL6] = { 44061, 44062, 44054, 44055, 44059, 44060, 44057, 44058, 44511, 41574 },
		[FACTION_STANDING_LABEL7] = { 44051, 44052, 44053, 44509, 45774 },
		[FACTION_STANDING_LABEL8] = { 44050, 44723 }
	},
	[BF["The Oracles"]] = {	
		[FACTION_STANDING_LABEL5] = { 41567, 44065 },
		[FACTION_STANDING_LABEL6] = { 44071 },
		[FACTION_STANDING_LABEL7] = { 44104, 44106, 44110, 44109, 44112, 44111, 44108, 41724, 39878 },
		[FACTION_STANDING_LABEL8] = { 44074 }
	},
	[BF["The Sons of Hodir"]] = {	
		[FACTION_STANDING_LABEL6] = { 44190, 44189, 44510, 44137, 44131, 44130, 44132, 44129 },
		[FACTION_STANDING_LABEL7] = { 43958, 44080, 44194, 44195, 44193, 44192 },
		[FACTION_STANDING_LABEL8] = { 43961, 44086, 44133, 44134, 44136, 44135, 41720, 42184 }
	},
	[BF["Winterfin Retreat"]] = {	
		[FACTION_STANDING_LABEL5] = { 36784, 37462, 37463, 37461, 36783, 37464, 37449, 38351, 38350,	17058, 17057, 34597 },
	},
	[BF["The Wyrmrest Accord"]] = {	
		[FACTION_STANDING_LABEL5] = { 43156 },
		[FACTION_STANDING_LABEL6] = { 44188, 44196, 44197, 44187, 44140 },
		[FACTION_STANDING_LABEL7] = { 44200, 44198, 44201, 44199, 44152, 42185 },
		[FACTION_STANDING_LABEL8] = { 44202, 44203, 44204, 44205, 43955, 41722 }
	},
...
function Altoholic.Loots:Find(name, SearchType, SearchSubType,	SearchRarity, MinLevel, MaxLevel, SearchSlot)
	self.TotalLoots = 0
	self.TotalUnknown = 0
	self.MaxAutoQuery = 5
	self.AutoQueriesDone = 0
	
	for Instance, BossList in pairs(self.List) do
		for Boss, LootList in pairs(BossList) do
			for _, itemID in pairs(LootList) do
				local matches, itemLevel = self:Match(itemID, name, SearchType, SearchSubType,
														SearchRarity, MinLevel, MaxLevel, SearchSlot)
	...
	Altoholic.Options:Set("TotalLoots", self.TotalLoots)
	Altoholic.Options:Set("UnknownLoots", self.TotalUnknown)
									
	self.TotalLoots = nil
	self.TotalUnknown = nil
	self.MaxAutoQuery = nil
	self.AutoQueriesDone = nil
end

function Altoholic.Loots:Match(itemID, name, SearchType, SearchSubType, SearchRarity, MinLevel, MaxLevel, SearchSlot)
	self.TotalLoots = self.TotalLoots + 1
	...
	if not itemName and not itemRarity then
		...
		self.TotalUnknown = self.TotalUnknown + 1
		
		if self.AutoQueriesDone < self.MaxAutoQuery then		-- find up to MaxAutoQuery new loots in next search
			if Altoholic.Options:Get("SearchAutoQuery") == 1 then
				if Altoholic.UnsafeItems:IsItemKnown(itemID) then		-- if the item is known to be unsafe .. exit !
					return
				end
			...
			self.AutoQueriesDone = self.AutoQueriesDone + 1
		end
		return
	end
	
	if SearchType and SearchType ~= itemType then
		return		-- if there's a type and it's invalid .. Exit
	end

	if SearchSubType and SearchSubType ~= itemSubType then
		return		-- if there's a subtype and it's invalid .. Exit
	end	

	if itemRarity < SearchRarity then
	...
	if (itemMinLevel == 0) then
		...
		if (itemMinLevel < MinLevel) or (itemMinLevel > MaxLevel) then
			return		-- not within the right level boundaries ? .. exit
		end
	end

	if SearchSlot ~= 0 then	-- if a specific equipment slot is specified ..
		if Altoholic.Equipment:GetInventoryTypeIndex(itemEquipLoc) ~= SearchSlot then
			return		-- not the right slot ? .. exit
		end
	end
	
	if string.find(strlower(itemName), name, 1, true) == nil then
...
function Altoholic.Loots:FindUpgrade(Search_iLvl, SearchType, SearchSubType, SearchEquipLoc)
	for Instance, BossList in pairs(self.List) do		-- parse the loot table to find an upgrade
		for Boss, LootList in pairs(BossList) do
			for _, itemID in pairs(LootList) do
				local matches, itemLevel = self:MatchUpgrade(itemID, Search_iLvl, SearchType, SearchSubType, SearchEquipLoc)
...
function Altoholic.Loots:MatchUpgrade(itemID, Search_iLvl, SearchType, SearchSubType, SearchEquipLoc)

	local itemName, _, itemRarity, itemLevel, _, itemType, itemSubType, _, itemEquipLoc = GetItemInfo(itemID)
	...
	if (itemLevel <= Search_iLvl) or (SearchType ~= itemType) or (SearchSubType ~= itemSubType) then
