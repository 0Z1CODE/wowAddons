...
function D:BetaWarning()
    ...
    if (("2.4.5.1"):lower()):find("beta") or ("2.4.5.1"):find("RC") or alpha then
        ...
        if D.VersionTimeStamp ~= 0 then
            ...
            if time() > D.VersionTimeStamp + VersionLifeTime then
                ...
                StaticPopup_Show ("Decursive_Notice_Frame", "|cff00ff00Decursive version: 2.4.5.1|r\n\n" .. "|cFFFFAA66" .. L["DEV_VERSION_EXPIRED"] .. "|r");
                return;
            end

        end

        if self.db.global.NonRealease ~= "2.4.5.1" then
            self.db.global.NonRealease = "2.4.5.1";
...
DcrLoadedFiles["DCR_init.lua"] = "2.4.5.1";
...
a9fa364de7f0003017bcde1dbdfe181b98bb0485
