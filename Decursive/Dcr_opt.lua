                ...
                args = {
                    ...
                    Title = {
                        ...
                        name = (
                                    ...
                                    "2.4.5.1", "Archarodim", ("2009-12-08T23:00:33Z"):sub(1,10),
                                    L["ABOUT_NOTES"],
...
function D:ShowDebugReport()
    ...
    if not DebugHeader then
        DebugHeader = ("%s\n2.4.5.1  %s  CT: %0.4f D: %s (%s, %s, %s, %s)"):format((Dcr and Dcr.L) and Dcr.L["DEBUG_REPORT_HEADER"] or "X|cFF11FF33Please report the content of this window to Archarodim@teaser.fr|r\n|cFF009999(Use CTRL+A to select all and then CTRL+C to put the text in your clip-board)|r\n", DC.MyClass, D:NiceTime(), date(), GetBuildInfo());
    end
...
DcrLoadedFiles["Dcr_opt.lua"] = "2.4.5.1";
