...
if not L then 
    DcrLoadedFiles["frFR.lua"] = "2.4.5.1";
    return;
end
...
L["ABOUT_NOTES"] = "Affichage et guérison des afflictions avec un système évolué de filtrage et de priorité."
...
Merci de télécharger la dernière version de développement ou d'utiliser la version stable courante sur CURSE.COM
...
Sélectionnez le type d'afflictions que vous souhaitez guérir. Cette priorité affecte plusieurs aspects de Decursive :
