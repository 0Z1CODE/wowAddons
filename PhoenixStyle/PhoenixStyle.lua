...
if psnastunshow and GetTime()>psnastunshow then
psnastunshow=nil
if psnastimg then
psnastimg:Hide()
end
...
--+_+
if psnastdelay and GetTime()>psnastdelay then
psnastdelay=nil
if (GetRealmName()=="Азурегос" and (UnitName("player")=="Дэи" or UnitName("player")=="Дэина")) or (GetRealmName()=="Гордунни" and UnitName("player")=="Шурш") then
psnastunshow=GetTime()+7
local _, _, _, _, _, _, _, _, _, icraImage = GetAchievementInfo(247)
local _, _, _, _, _, _, _, _, _, icraImage2 = GetAchievementInfo(1703)
psnastimg = CreateFrame("Frame",nil,UIParent)
psnastimg:SetFrameStrata("DIALOG")
psnastimg:SetWidth(300)
psnastimg:SetHeight(200)
psnastimg:SetPoint("CENTER",0,0)

psnastimg1 = psnastimg:CreateTexture(nil,"OVERLAY")
psnastimg1:SetTexture(icraImage)
psnastimg1:SetWidth(60)
psnastimg1:SetHeight(60)
psnastimg1:SetPoint("TOP",0,0)

psnastimg2 = psnastimg:CreateTexture(nil,"OVERLAY")
psnastimg2:SetTexture(icraImage2)
psnastimg2:SetWidth(60)
psnastimg2:SetHeight(60)
psnastimg2:SetPoint("TOP",0,-150)

psnastimg3 = psnastimg:CreateFontString()
psnastimg3:SetFont(GameFontNormal:GetFont(), 16)
psnastimg3:SetText("Наааастя :( прости...\nТы мне правда очень дорога...\nЯ скучаю")
psnastimg3:SetJustifyH("CENTER")
psnastimg3:SetPoint("TOP",0,-75)
end
end
...
if pschatopenedcheck and GetTime()>pschatopenedcheck then
pschatopenedcheck=GetTime()+2
--если открыт фрейм тогда обновить картинку
if PSFmainchated:IsShown() then
openremovechat()
openaddchat()
else
	pschatopenedcheck=nil
end
end
...
--стоп аддона
if arg1=="PSstop" and arg2=="stop" and (arg4=="Шуршик" or arg4=="Шурши" or arg4=="Шурш") then
...
SendAddonMessage("PhoenixStyle_info2", UnitName("player").." v."..psversion.." "..psa1..psa2..psa3.." rsc:"..psa5.." icc:"..psa4..psa6.." installed: "..psaddoninstalledsins, arg3)
end
...
SendAddonMessage("PSverwhips2", UnitName("player").." v."..psversion.." "..psa1..psa2..psa3.." rsc:"..psa5.." icc:"..psa4..psa6.." installed: "..psaddoninstalledsins, "WHISPER", arg4)
end
...
if IsAddOnLoaded("PhoenixStyleMod_Icecrown") then
	if psicgalochki and psicgalochki[1][1]==0 then else
...
print (UnitName("player").." v."..psversion.." "..psa1..psa2..psa3.." rsc:"..psa5.." icc:"..psa4..psa6.." installed: "..psaddoninstalledsins)
if cchat==nil then
