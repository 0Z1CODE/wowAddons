...
if GetRealZoneText()==pszoneulduar then
	...
	PhoenixStyleMod_Ulduar:RegisterEvent("PLAYER_REGEN_DISABLED")
	PhoenixStyleMod_Ulduar:RegisterEvent("PLAYER_REGEN_ENABLED")
	PhoenixStyleMod_Ulduar:RegisterEvent("ZONE_CHANGED_NEW_AREA")
...
function psfUlduaronevent(self,event,...)
