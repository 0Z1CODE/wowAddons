...
AddonTable.Castable["Hammer of Wrath"] = function()
	local z = {}
	z.SpellName = SpellName(24275--[[Hammer of Wrath]])
	z.EnemyTargetNeeded = 1
	return SpellFlashAddon.CheckIfSpellCastable(z)
end

AddonTable.Castable["Avenging Wrath"] = function()
	local z = {}
	z.SpellName = SpellName(31884--[[Avenging Wrath]])
	z.EnemyTargetNeeded = 1
	return SpellFlashAddon.CheckIfSpellCastable(z)
end

AddonTable.Castable["Judgement of Wisdom"] = function()
	local z = {}
	z.SpellName = SpellName(53408--[[Judgement of Wisdom]])
	z.EnemyTargetNeeded = 1
	return SpellFlashAddon.CheckIfSpellCastable(z)
end

AddonTable.Castable["Crusader Strike"] = function()
	local z = {}
	z.SpellName = SpellName(35509--[[Crusader Strike]])
	z.EnemyTargetNeeded = 1
	return SpellFlashAddon.CheckIfSpellCastable(z)
end

AddonTable.Castable["Divine Storm"] = function()
	if not SpellFlashAddon.MeleeDistance() then
		return false
	end
	local z = {}
	z.SpellName = SpellName(53385--[[Divine Storm]])
	z.EnemyTargetNeeded = 1
	return SpellFlashAddon.CheckIfSpellCastable(z)
end

AddonTable.Castable["Consecration"] = function()
	if not SpellFlashAddon.MeleeDistance() then
		return false
	end
	local z = {}
	z.SpellName = SpellName(26573--[[Consecration]])
	z.EnemyTargetNeeded = 1
	return SpellFlashAddon.CheckIfSpellCastable(z)
end

AddonTable.Castable["Exorcism"] = function()
	local z = {}
	z.SpellName = SpellName(879--[[Exorcism]])
	z.EnemyTargetNeeded = 1
	return SpellFlashAddon.CheckIfSpellCastable(z)
end

AddonTable.Castable["Divine Plea"] = function()
	if PowerPercent("player") > 75 then
		return false
	end
	local z = {}
	z.SpellName = SpellName(54428--[[Divine Plea]])
	z.EnemyTargetNeeded = 1
	return SpellFlashAddon.CheckIfSpellCastable(z)
end

AddonTable.Castable["Sacred Shield"] = function()
	local z = {}
	z.SpellName = SpellName(53601--[[Sacred Shield]])
	z.EnemyTargetNeeded = 1
	return SpellFlashAddon.CheckIfSpellCastable(z)
end
