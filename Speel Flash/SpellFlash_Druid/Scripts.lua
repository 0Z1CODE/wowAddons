...
local function Castable(English_Spell_Name, ...)
	...
	print(tostring(English_Spell_Name), ": has not been defined in a function!")
	return false
end
...
local function ItemCastable(English_Item_Name, ...)
	...
	print(tostring(English_Item_Name), ": has not been defined in a function!")
	return false
end
...
s.Spam[AddonName] = function(x)
	if s.GetModuleConfig(AddonName, "spell_flashing_off") then return elseif AddonTable.Spam then RunSpamTable(x) else
