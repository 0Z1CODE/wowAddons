...
AddonTable.VehicleCastable["Defend"] = function()
	local z = {}
	z.SpellName = SpellName(62552--[[Defend]])
	z.NoRangeCheck = 1
	return SpellFlashAddon.CheckIfVehicleSpellCastable(z)
end
...
AddonTable.VehicleCastable["Shield-Breaker"] = function()
	local z = {}
	z.SpellName = SpellName(62575--[[Shield-Breaker]])
...
AddonTable.VehicleCastable["Charge"] = function()
	local z = {}
	z.SpellName = SpellName(62960--[[Charge]])
	z.EnemyTargetNeeded = 1
	z.GlobalVehicleCooldownSpell = SpellName(62575--[[Shield-Breaker]])
	return SpellFlashAddon.CheckIfVehicleSpellCastable(z)
end

AddonTable.VehicleCastable["Thrust"] = function()
	local z = {}
	z.SpellName = SpellName(62544--[[Thrust]])
	z.EnemyTargetNeeded = 1
	return SpellFlashAddon.CheckIfVehicleSpellCastable(z)
end
